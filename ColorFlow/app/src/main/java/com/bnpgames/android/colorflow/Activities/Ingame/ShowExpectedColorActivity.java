...
import com.bnpgames.android.colorflow.Resources.ClickListener;
...
public class ShowExpectedColorActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gameModeTitle.setText(String.format(getString(R.string.level_resource),game.getIndex()));
        //gameModeTitle.setText(String.format("%s Mode",game.getFlowMode().name()));
